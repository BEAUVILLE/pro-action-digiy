...
(function(){
  ...
  function routeItems(t){
    ...
    return [
      ...
      one('architect','📐','ARCHITECTE · SERVICES','services','architecte',['architecte','architecture','plans','plan de maison','faire les plans','dessiner les plans','concevoir une maison','concevoir une villa','permis de construire']),
      ...
      one('resto','🍽️','MANGER · RESTO','food','restaurant',['restaurant','resto','manger','j ai faim','j’ai faim','on a faim','table','table pour deux','table pour 2','diner','dîner','dejeuner','déjeuner','petit dejeuner','petit déjeuner','repas','manger du poisson','poisson grille','poisson grillé','a emporter','à emporter','livraison repas','snack','traiteur','boulangerie']),
      one('commerce','🛍️','ACHETER LOCAL · COMMERCE','shopping','commerce',['commerce','commerces','boutique','magasin','acheter','produit','article','commande','shopping','linge','linge de maison','serviette','serviettes','drap','draps','peignoir','peignoirs','vetement','vêtement','vetements','vêtements','tee shirt','tee-shirt','t shirt','t-shirt','polo','polos','robe','robes','chaussure','chaussures','sandale','sandales','sac','sacs','tissu','tissus','telephone','téléphone','accessoire','accessoires']),
      one('beauty','💅','BEAUTÉ & BIEN-ÊTRE','beauty','beauté',['beaute','beauté','onglerie','ongles','faire mes ongles','faire les ongles','manucure','pedicure','pédicure','soin des pieds','vernis','pose gel','faux ongles','massage','bien etre','bien-être','coiffure','coiffeur','coiffeuse','me faire coiffer','faire coiffer','tresses','tresser','nattes','cheveux','couper mes cheveux','coupe cheveux','brushing','salon de beauté','salon de beaute','salon de coiffure','spa','hammam','sauna','soins']),
