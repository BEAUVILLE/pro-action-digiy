...
(function(){
  ...
  document.write('<script src="./voice-territory-rails-v1.js?v=20260920-france-multi-need-v5"><\/script>');
  document.write('<script src="./voice-territory-intent-filter-v1.js?v=20260920-multi-intent-v3"><\/script>');
