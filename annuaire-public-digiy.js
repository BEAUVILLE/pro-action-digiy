...
(function(){
  ...
  document.write('<script src="./voice-territory-rails-v1.js?v=20260920-ma-us-multi-need-v6"><\/script>');
  document.write('<script src="./voice-territory-intent-filter-v1.js?v=20260920-ma-us-multi-intent-v4"><\/script>');
