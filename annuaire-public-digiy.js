...
(function(){
  ...
  document.write('<script src="./voice-territory-rails-v1.js?v=20260926-terrain-pack-v9"><\/script>');
  document.write('<script src="./voice-territory-intent-filter-v1.js?v=20260926-terrain-pack-v9"><\/script>');
