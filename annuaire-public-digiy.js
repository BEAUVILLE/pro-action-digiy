/* ACTION PRO — chargeur annuaire + verrou public Supabase — 2026-08-29 */
(function(){
  'use strict';
  document.write('<script src="./annuaire-public-digiy-core.js?v=20260826-fg-retire-v3"><\/script>');
  document.write('<script src="./voice-territory-rails-v1.js?v=20260901-france-questions-v3"><\/script>');
  document.write('<script src="./voice-territory-intent-filter-v1.js?v=20260829-senegal-intent-v1"><\/script>');
